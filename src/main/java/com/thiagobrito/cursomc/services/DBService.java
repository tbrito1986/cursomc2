...
public class DBService {
	...
	public void instantiateTesTestDataBase() throws ParseException {
		
		Categoria cat1 = new Categoria(null, "Informatica");
		Categoria cat2 = new Categoria(null, "Escritório");
		Categoria cat3 = new Categoria(null, "Tijolo");
		...
		Pedido ped2 = new Pedido(null, stf.parse("07/07/2019 10:34"), cli2, e2);
